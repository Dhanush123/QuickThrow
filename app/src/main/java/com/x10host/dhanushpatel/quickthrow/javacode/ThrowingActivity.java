...
import com.x10host.dhanushpatel.quickthrow.interfaces.Constants;
import com.x10host.dhanushpatel.quickthrow.interfaces.GPSCallback;
import com.x10host.dhanushpatel.quickthrow.managers.GPSManager;

import java.math.BigDecimal;
import java.math.RoundingMode;

public class ThrowingActivity extends AppCompatActivity implements GPSCallback{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        measurement_index = com.x10host.dhanushpatel.quickthrow.settings.AppSettings.getMeasureUnit(this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId())
        {
            ...
            case R.id.unit_km:
            {
                ...
                com.x10host.dhanushpatel.quickthrow.settings.AppSettings.setMeasureUnit(this, 0);
            ...
            case R.id.unit_miles:
            {
                ...
                com.x10host.dhanushpatel.quickthrow.settings.AppSettings.setMeasureUnit(this, 1);
